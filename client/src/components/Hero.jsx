  ...
  return (
    <div className='heroic flex justify-center items-center' name = "Top">
      <div className='Words flex-col flex max-w-[50rem] text-center justify-center items-center'>
        ...
        <button className="border w-40 rounded-full h-11 bg-Comp text-black my-4 flex items-center justify-center space-x-2"><Link to="upload" smooth={true} offset={-200}><span>Explore more</span></Link> <MdArrowCircleRight className='text-NewAccent'/></button>
      </div>
    </div>
  )
}
